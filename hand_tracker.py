...
class HandTracker:
    ...
    def draw_advanced_visuals(self, frame, landmarks):
        ...
        # 1. Draw Internal Skeleton (Clean White Lines)
        self.mp_draw.draw_landmarks(
            frame, 
            landmarks, 
            self.mp_hands.HAND_CONNECTIONS,
        ...
        outline_indices = [
            ...
            8,                  # Index Tip (Jump from Thumb Tip to Index Tip is tricky, so we skip)
            5, 6, 7, 8,         # Index
            9, 10, 11, 12,      # Middle
            13, 14, 15, 16,     # Ring
            17, 18, 19, 20,     # Pinky
        ...
        # Draw specific contour lines for a cleaner look
        # Thumb to Wrist
        ...
        # Fingers (Up and Down)
        # We simply rely on the skeleton for the fingers themselves to keep it clean,
        # but we can draw a line connecting the fingertips to show the "Span"
        tips = [4, 8, 12, 16, 20]
    ...
    def draw_blueprint(self, frame):
        ...
        color = (200, 200, 200) # Soft Grey
        thickness = 2
        
        # Simple rounded rectangle look for the target zone
